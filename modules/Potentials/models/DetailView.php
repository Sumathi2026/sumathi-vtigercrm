...
class Potentials_DetailView_Model extends Vtiger_DetailView_Model {
	...
	public function getDetailViewLinks($linkParams) {
		...
		// ---------------- Existing Convert Potential Action ----------------
		...
		$approvalStatus = $recordModel->get('approval_status');
		if ($approvalStatus === 'Pending') {
			$approveLink = array(
				'linktype' => 'DETAILVIEWBASIC',
				'linklabel' => 'Approve',
				'linkurl' => "javascript:Potentials_Detail_Js.approveOrReject('index.php?module=Potentials&action=ApproveOrReject', 'Approved');",
				'linkicon' => ''
			);
			$rejectLink = array(
				'linktype' => 'DETAILVIEWBASIC',
				'linklabel' => 'Reject',
				'linkurl' => "javascript:Potentials_Detail_Js.approveOrReject('index.php?module=Potentials&action=ApproveOrReject', 'Rejected');",
				'linkicon' => ''
			);
	...
	public function getWidgets() {
		...
		// Add all widgets to widgetLinks
